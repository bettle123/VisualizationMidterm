...
function Barplot1()
{
	...
	var dep = [{label: "on-time", pr: (1-dep_delay_pr)},
            {label: "delay", pr: dep_delay_pr}];
		...
		.on("mouseover", function(d){
			...
			if(tmp_label=="delay")
			{
				tmp.append("div").append("text")
					.text("Average delay time = "+(d3.format("0.2s")(dep_delay_time))+" minutes");
			}
	...
	.attr("font-weight", "bold")
	.attr("text-anchor", "start")
	.text("the Probability of Departure Airport");
