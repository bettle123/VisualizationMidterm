...
function displayPie()
{
	...
	var pie = new d3pie("pie", {
		header: {
			title: {
				text: "Percentage of each reason of delay",
				fontSize: 30
			}
		},
		data: {
			content: [
				{ label: "Carrier Delay", value: 75381 },
				{ label: "Weather Delay", value: 11556 },
				{ label: "NAS(National Air System) Delay", value: 81925},
				{ label: "Security Delay", value: 493},
				{ label: "Late Aircraft Delay", value: 83229}
			]
		}
	});
}